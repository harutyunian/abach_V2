...
const translations = {
  am: {
    ...
    'hero.experience': 'Պրեմիում բարբերական փորձ',
    ...
    'features.mobile.desc': 'Հայաստանի առաջին շարժական բարբերշոփը՝ գալիս ենք ձեզ մոտ',
    'features.expert.title': 'Փորձառու բարբերներ',
    ...
    // Mobile Barbershop
    'mobile.title': 'Միակ շարժական բարբերությունը',
    ...
    'mobile.cta_title': 'Պատրա՞ստ եք շարժական բարբերինգին?',
    'mobile.cta_note': 'Զանգահարեք, և մեքենան կժամանի ձեր ցանկալի վայր։',
    'mobile.banner.rank': '#1',
    'mobile.banner.title': 'Շարժական բարբերշոփ',
    'mobile.banner.subtitle': 'Հայաստանում',
    
    // About
    'about.title': 'Մեր մասին',
    'about.header_subtitle': 'Բարի գալուստ Հայաստանի առաջին բարբերի ակադեմիա և պրեմիում խնամքի տարածք',
    'about.hero_title': 'Հայաստանի առաջին բարբերի ակադեմիա «ABACH»',
    'about.description': 'Բարի գալուստ Հայաստանի առաջին բարբերի ակադեմիա «Abach»։ Ցանկանու՞մ եք դառնալ հմուտ բարբեր։',
    'about.p1': 'Ցանկանու՞մ եք տիրապետել այն հմտություններին, որոնք միշտ արդիական են։ Եկեք մեզ մոտ՝ մենք կսովորեցնենք։',
    'about.p2': 'Առաջին անգամ Հայաստանում բացվեց բարբերների դպրոց։ 4 տարիների ընթացքում կուտակել ենք մեծ փորձ։',
    ...
    'about.karo_title': 'Հիմնադիր և բարբեր-մաստեր',
    'about.karo_quote': '"Սպասում ենք ձեզ. մի կորցրեք հնարավորությունը"',
    'about.ach.graduates.label': 'Շրջանավարտներ',
    'about.ach.graduates.desc': 'Մասնագիտական բարբերներ՝ մեր ակադեմիայից',
    ...
    'about.academy.title': 'Միացեք մեր բարբերի ակադեմիային',
